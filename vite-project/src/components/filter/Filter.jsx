...
function Filter() {
  ...
  const resetFilters = () => {
    ...
    setFilterType(""); // Reset filter type to default
    setFilterPrice(""); // Reset filter price to default
  };
  ...
  return (
    <div className="container mx-auto px-4 mt-5">
      ...
      <div
        className="p-5 rounded-lg bg-teal-700 drop-shadow-xl border border-gray-200"
        style={{
